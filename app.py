...
app.config['DB_TYPE'] = os.getenv('DB_TYPE', 'sqlite')  # по умолчанию sqlite (PythonAnywhere)

if app.config['DB_TYPE'] == 'postgres':
    db_name = 'filatova_viktoriya_orm'
    db_user = 'filatova_viktoriya_orm'
    db_password = '123'
    host_ip = '127.0.0.1'
    host_port = 5432
    ...
    db_path = path.join(dir_path, 'filatova_viktoriya_orm.db')
