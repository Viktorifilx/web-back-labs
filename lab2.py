...
# --- добавление цветка: можно с ценой и без (тогда цена = 0) ---
@lab2.route('/lab2/add_flower/<name>/', defaults={'price': 0})
...
def example():
    ...
    return render_template(
        'lab2/example.html',
        name=name, group=group, course=course, lab_number=lab_number, fruits=fruits
    )
...
def gallery():
    return render_template('lab2/gallery.html', objects=objects)
